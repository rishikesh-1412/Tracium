// processCustomHourlyJobs.js
async function processCustomHourlyJobs(jobs, startDate, endDate, connection, results) {
    ...
    for (const job of jobs) {
        ...
        // Generate expected times from baseDate to end
        for (let d = new Date(baseDate); d <= end; d.setHours(d.getHours() + interval)) {
...
module.exports = { processCustomHourlyJobs };
